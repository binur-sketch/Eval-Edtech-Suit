  ...
  const categories = [
    {
      ...
      clients: [
        ...
        { name: 'Resonance', logo: '/assets/images/coaching/Resonance.jpg' },
        ...
        { name: 'Career Launcher', logo: '/assets/images/coaching/career launcher.jpg' },
        { name: 'IMS LEARNING', logo: '/assets/images/coaching/ims.webp' },
        { name: 'Him Academy', logo: '/assets/images/coaching/him academy.png' }
      ]
    },
    {
      title: 'Schools',
      clients: [
        ...
        { name: 'RPS International', logo: '/assets/images/school/RPS International School.jpg' },
        { name: 'Dr. Radhakrishnan Intl.', logo: '/assets/images/school/Dr. Radhakrishnan International School.png' },
        { name: 'Bankura Hindu High School', logo: '/assets/images/school/BANKURA HINDU HIGH SCHOOL.jpg' },
        { name: 'Mata Harki Devi Sr Sec', logo: '/assets/images/school/Mata Harki Devi Senior secondary School.jpg' },
        { name: 'SURAJ SCHOOL', logo: '/assets/images/school/SURAJ SCHOOL.jpg' },
        ...
        { name: 'OASIS International', logo: '/assets/images/school/OASIS International School.jpg' },
        { name: 'Jawahar Navodaya', logo: '/assets/images/school/Jawahar Navodaya Vidyalaya.png' },
        { name: 'Uttam School', logo: '/assets/images/school/Uttam School for Girls.jpg' },
        { name: 'DAV School', logo: '/assets/images/school/DAV School.avif' },
        { name: 'ICFAI Business School', logo: '/assets/images/school/ICFAI Business School.jpg' }
      ]
    },
    {
      title: 'Universities',
      clients: [
        ...
        { name: 'Parul University', logo: '/assets/images/university/Parul University.jpg' },
        { name: 'Jamia Millia Islamia', logo: '/assets/images/university/Jamia Millia Islamia.jpg' },
        ...
        { name: 'Assam Skill Univ', logo: '/assets/images/university/Assam Skill University.jpg' },
        ...
        { name: 'RG Aviation Univ', logo: '/assets/images/university/RAJIV GANDHI NATIONAL AVIATION UNIVERSITY.jpg' },
        ...
        { name: 'Dada Lakhmi Chand Univ', logo: '/assets/images/university/DADA LAKHMI CHAND STATE UNIVERSITY.jpg' },
    ...
    },
    {
      ...
      clients: [
        ...
        { name: 'UPSC', logo: '/assets/images/government/Union Public Service Commission.jpg' },
        { name: 'Unani Medicine Inst', logo: '/assets/images/government/NATIONAL INSTITUTE OF UNANI MEDICINE.jpg' },
        ...
        { name: 'CBEC India', logo: '/assets/images/government/Central Board of Excise and Customs.jpg' },
        ...
        { name: 'CSIR', logo: '/assets/images/government/Council of Scientific and Industrial Research.png' }
      ]
    }
  ];
    ...
    <div style={{ paddingTop: 'var(--nav-height)' }}>
          ...
          <div style={{ background: 'var(--secondary)', color: 'white', padding: '6rem 4rem', borderRadius: '4rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'center' }}>
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{ display: 'grid', gap: '1rem' }}>
                ...
                <a href="tel:9315152290" className="btn btn-outline" style={{ color: 'white', borderColor: 'rgba(255,255,255,0.2)', padding: '1.5rem' }}>Call HQ (+91) 931-515-2290</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding">
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <button className="btn btn-primary" style={{ padding: '1.25rem 4rem' }}>Request Institutional Demo</button>
        </div>
      </section>
    </div>
  );
