...
const About = () => {
  ...
  const milestones = [
    ...
    { year: '2022', title: 'DigiLib & Board Scale', desc: 'Delivered IIC DigiLib digital repository, successfully evaluated 30 lakh OMR sheets for a major education board in India.', icon: <Icons.Database size={20} /> },
